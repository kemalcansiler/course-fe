...
export class CourseDetailService {
  ...
  private mockCourseDetail: CourseDetail = {
    ...
    description: 'A comprehensive course covering all aspects of modern web development. Perfect for beginners who want to become professional developers.',
    ...
    curriculum: [
      {
        ...
        isExpanded: true,
        lessons: [
          { id: '1-1', title: 'Course Introduction', duration: '05:00', isPreview: true, type: 'video' },
          { id: '1-2', title: 'What is Web Development?', duration: '10:00', isPreview: false, type: 'video' },
          { id: '1-3', title: 'Setting up Development Environment', duration: '15:00', isPreview: false, type: 'video' },
          { id: '1-4', title: 'Introduction to HTML', duration: '20:00', isPreview: true, type: 'video' },
          { id: '1-5', title: 'HTML Basics Practice', duration: '25:00', isPreview: false, type: 'video' },
          { id: '1-6', title: 'Introduction to CSS', duration: '15:00', isPreview: true, type: 'video' },
        ],
      },
      {
        id: '2',
    ...
    instructor: {
      ...
      totalStudents: 2500,
      totalCourses: 5,
      description: 'John is a senior web developer with 8+ years of experience in building modern web applications.',
      socialLinks: [
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '1 week ago',
        comment: 'Great course! Perfect for beginners. The instructor explains everything clearly and step by step.',
        helpful: 8,
        verified: true,
      },
      {
